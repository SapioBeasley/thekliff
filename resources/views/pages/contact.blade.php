        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main-pagination clearfix">
                    ...
                    <div class="col-md-6">
                        <div class="text-left">
                            <a href="contact.html#" class="active"><i class="fa fa-long-arrow-left"></i> BEAUTIFUL WINTER WITH THEKLIFF</a>
                        </div>
                    </div>
                    <!-- .prev -->
                    ...
                    <div class="col-md-6">
                        <div class="text-right">
                            <a href="contact.html#">OUR TRIP TO FASHION WEEK <i class="fa fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                    <!-- .next -->

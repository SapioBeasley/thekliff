                ...
                <div class="page-title">
                    ...
                    <div class="title-content">
                        <div class="title-content-wrap">
                            <p class="small-text">Updated December 8, 2015</p>

                            <p class="big-text">PRIVACY &amp; SECURITY</p>
                        </div>
                    </div>
                    <!-- .page title content -->
                ...
                <div class="about clearfix">
                    ...
                    <div class="col-md-8 no-padding col-sm-offset-2">
                        <div class="blog-single-content-wrap">
                                ...
                                <!-- title -->
                                <div class="blog-single-title">
                                    <h1>Our Privacy Policy Will Change Over Time</h1>
                                    <span class="bottom-border"></span>
                                </div>
                                <!-- .title -->
                                ...
                                <!-- title -->
                                <div class="blog-single-title">
                                    <h1>What are Cookies and How Does our Websites Use Them?</h1>
                                    <span class="bottom-border"></span>
                                </div>
                                <!-- .title -->
